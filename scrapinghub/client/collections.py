...
class Collections(_Proxy[_Collections]):
    ...
    def get(self, type_: str, name: str) -> Collection:
    ...
    def get_store(self, name: str) -> Collection:
    ...
    def get_cached_store(self, name: str) -> Collection:
    ...
    def get_versioned_store(self, name: str) -> Collection:
    ...
    def get_versioned_cached_store(self, name: str) -> Collection:
...
class Collection(object):
    ...
    def __init__(self, client: ScrapinghubClient, collections: Collections,
                 type_: str, name: str) -> None:
        self._client = client
        self._collections = collections
        self._origin = _Collection(type_, name, collections._origin)

    def get(self, key: str, **params: Any) -> Any:
    ...
    def iter(self, key: str | Iterable[str] | None = None,
             prefix: str | Iterable[str] | None = None,
             prefixcount: int | None = None, startts: int | None = None,
             endts: int | None = None,
    ...
    def list(self, key: str | Iterable[str] | None = None,
             prefix: str | Iterable[str] | None = None,
             prefixcount: int | None = None, startts: int | None = None,
             endts: int | None = None,
             requests_params: dict[str, Any] | None = None,
    ...
    def create_writer(
        self, start: int = 0, auth: str | tuple[str, str] | None = None,
        size: int = 1000, interval: float = 15, qsize: int | None = None,
